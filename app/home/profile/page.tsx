...
function ProfilePageContent() {
  ...
  if (profileError || userDataError || userError) {
    console.warn("Profile page query errors:", {
      profileError,
      userDataError,
      userError,
    });
          ...
          <Card className="border-teal-200 bg-gradient-to-br from-teal-50 to-white">
            ...
            <CardContent className="space-y-4">
              <p className="text-sm text-slate-600">
                Got an idea to make SpareCarry better? If your idea is used, you
                get a lifetime Pro subscription.
              </p>
              <Button
            ...
            {userData?.subscription_status === "active" && (
              <div className="rounded-md border border-green-200 bg-green-50 p-3">
                ...
                <p className="mt-1 text-sm text-green-800">
                  Your subscription is active. Enjoy 0% platform fees and
                  priority placement!
                </p>
              </div>
            )}
