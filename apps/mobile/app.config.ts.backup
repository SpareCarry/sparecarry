    ...
    ios: {
      ...
      infoPlist: {
        NSCameraUsageDescription:
          "SpareCarry needs camera access to take photos of items.",
        NSLocationWhenInUseUsageDescription:
          "SpareCarry needs location access to find nearby trips and requests.",
        NSLocationAlwaysUsageDescription:
          "SpareCarry needs location access to find nearby trips and requests.",
        NSPhotoLibraryUsageDescription:
          "SpareCarry needs photo library access to select images.",
      },
    },
    android: {
      adaptiveIcon: {
