...
export function UseCurrentLocationButton({
  ...
  const getCurrentLocation = async () => {
    ...
    try {
      ...
      if (showOnlyMarinas && place.category !== 'marina' && place.category !== 'port') {
  ...
  return (
    <div className={className}>
      ...
      {error && (
        <div className="mt-2 flex items-start gap-2 p-2 bg-amber-50 border border-amber-200 rounded text-sm text-amber-800">
