...
export const PLANE_PLATFORM_FEE_PERCENT = process.env
  .NEXT_PUBLIC_PLANE_FEE_PERCENT
  ? parseFloat(process.env.NEXT_PUBLIC_PLANE_FEE_PERCENT) / 100
  : 0.18; // Default 18% for plane

export const BOAT_PLATFORM_FEE_PERCENT = process.env
  .NEXT_PUBLIC_BOAT_FEE_PERCENT
