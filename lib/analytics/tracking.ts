...
export type AnalyticsEvent =
  ...
  | {
      type: "message_sent";
      data: { post_type: "trip" | "request"; thread_id: string };
    }
  | {
  ...
  | {
      ...
      data: { points: number; weight: number; platform_fee: number };
    }
  | {
      type: "restricted_items_selected";
      data: { post_type: "trip" | "request"; transport_method: string };
    }
  | { type: "category_selected"; data: { category: string; is_other: boolean } }
  | {
      type: "photo_uploaded";
      data: { count: number; post_type: "trip" | "request" };
    }
  | {
      type: "location_selected";
      data: {
        method: "autocomplete" | "map" | "gps";
        location_type: "departure" | "arrival";
      };
    }
  | {
  ...
  | {
      ...
      data: { reason_id: string; entity_type: "trip" | "request" | "match" };
    }
  ...
  | {
      type: "idea_submitted";
      data: { idea_id?: string; user_id?: string; platform?: string };
    }
  | {
      type: "idea_accepted";
      data: { idea_id: string; user_id: string; reward_granted: boolean };
    }
...
export function trackShippingEstimatorUsed(
...
export function trackEmergencySelected(
  baseReward: number,
...
export function trackKarmaPointsEarned(
  points: number,
  weight: number,
  platformFee: number
) {
...
export function trackRestrictedItemsSelected(
  postType: "trip" | "request",
...
export function trackLocationSelected(
  method: "autocomplete" | "map" | "gps",
  locationType: "departure" | "arrival"
) {
  analytics.track({
    type: "location_selected",
...
export function trackPremiumDiscountApplied(
...
export function trackSuggestedMatchClicked(
  tripId: string,
  requestId: string,
  confidence: "high" | "medium" | "low",
  score: number
...
export function trackCancellationReasonSelected(
  reasonId: string,
...
export function trackIdeaSubmitted(
  ideaId?: string,
  userId?: string,
  platform?: string
) {
...
export function trackIdeaAccepted(
  ideaId: string,
  userId: string,
