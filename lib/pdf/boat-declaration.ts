...
<body>
  ...
  <div class="declaration">
    ...
    <p>
      I understand that false declarations may result in penalties and legal action. I certify that 
  ...
  <div class="footer">
    ...
    <p style="margin-top: 10px;">
      Generated by CarrySpace - ${new Date().toLocaleDateString()} ${new Date().toLocaleTimeString()}
    </p>
  </div>
