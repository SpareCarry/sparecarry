...
const COUNTRY_RESTRICTIONS: CountryRestriction[] = [
  {
    ...
    restrictions: {
      ...
      notes: 'Australia has strict biosecurity laws. Food, plants, and some medical items require permits.',
    },
  },
  {
    ...
    restrictions: {
      ...
      notes: 'New Zealand has strict biosecurity requirements. Food items generally prohibited.',
    },
  },
  {
    ...
    restrictions: {
      ...
      notes: 'Firearms and ammunition require special permits and documentation.',
    },
  },
  {
  ...
  },
  {
    ...
    restrictions: {
      prohibitedItems: ['weapons'],
      requiresDocumentation: ['medical', 'electronics'],
      notes: 'Firearms require licenses. Some electronics may require documentation.',
    },
  },
  {
  ...
  },
  {
    ...
    restrictions: {
      prohibitedItems: ['weapons'],
      requiresDocumentation: ['medical', 'electronics'],
      notes: 'Firearms require permits. Some electronics may require CE marking documentation.',
    },
  },
  {
  ...
  },
  {
    ...
    restrictions: {
      prohibitedItems: ['weapons'],
      requiresDocumentation: ['medical', 'food'],
      notes: 'Firearms require permits. Dietary supplements and cosmetics may be restricted.',
    },
  },
  {
  ...
  },
  {
    ...
    restrictions: {
      ...
      notes: 'Japan has strict import regulations. Food and medical items require permits. Electronics may need certification.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedCategories: ['food', 'medical'],
      requiresDocumentation: ['electronics', 'tools'],
      notes: 'China has strict import regulations. Food, medical items, and electronics require permits and certification.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedCategories: ['food'],
      requiresDocumentation: ['medical', 'electronics'],
      notes: 'Food items may be restricted. Medical items and electronics require documentation.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedCategories: ['food'],
      requiresDocumentation: ['medical', 'electronics'],
      notes: 'Food items may be restricted. Medical items and electronics require ANVISA approval.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedItems: ['weapons'],
      requiresDocumentation: ['medical', 'food'],
      notes: 'Firearms require permits. Medical items and food may require documentation.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedCategories: ['food', 'medical'],
      prohibitedItems: ['weapons'],
      notes: 'UAE has strict import regulations. Food, medical items, and firearms are heavily restricted.',
    },
  },
  {
    ...
    restrictions: {
      prohibitedCategories: ['food', 'medical'],
      prohibitedItems: ['weapons'],
      notes: 'Saudi Arabia has strict import regulations. Food, medical items, and firearms are heavily restricted.',
    },
  },
];
 ...
 */
export function getCountryRestrictions(countryCode: string): CountryRestriction | undefined {
  return COUNTRY_RESTRICTIONS.find(r => r.countryCode === countryCode.toUpperCase());
}
...
export function isCategoryProhibitedForCountry(
  ...
  return restriction.restrictions.prohibitedCategories?.some(
    prohibited => categoryLower.includes(prohibited.toLowerCase())
  ) ?? false;
}
...
export function requiresDocumentationForCountry(
  ...
  const categoryLower = category.toLowerCase();
  return restriction.restrictions.requiresDocumentation?.some(
    required => categoryLower.includes(required.toLowerCase())
  ) ?? false;
}
