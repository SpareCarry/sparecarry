...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  electronics: [
    'iphone', 'ipad', 'laptop', 'computer', 'tablet', 'phone', 'smartphone',
    'headphone', 'earbud', 'charger', 'cable', 'battery', 'power bank',
    'electronic', 'device', 'gadget', 'tv', 'monitor', 'screen'
  ],
  clothing: [
    'shirt', 'pants', 'dress', 'jacket', 'coat', 'sweater', 'hoodie',
    'jeans', 'shorts', 'skirt', 'clothing', 'apparel', 'fashion',
    't-shirt', 'tshirt', 'top', 'bottom', 'outfit'
  ],
  shoes: [
    'shoe', 'boot', 'sneaker', 'sandal', 'flip flop', 'heels',
    'running shoe', 'footwear', 'slipper'
  ],
  cosmetics: [
    'makeup', 'cosmetic', 'perfume', 'lotion', 'cream', 'shampoo',
    'soap', 'skincare', 'beauty', 'lipstick', 'mascara'
  ],
  tools: [
    'tool', 'screwdriver', 'hammer', 'wrench', 'drill', 'saw',
    'equipment', 'hardware'
  ],
  books: [
    'book', 'novel', 'textbook', 'magazine', 'manual', 'guide',
    'literature', 'reading'
  ],
  food: [
    'food', 'snack', 'chocolate', 'coffee', 'tea', 'spice',
    'ingredient', 'grocery', 'drink', 'beverage'
  ],
};
