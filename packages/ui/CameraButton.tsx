...
type CameraButtonComponent = (props: CameraButtonProps) => JSX.Element;
...
if (isWeb) {
  ...
  const { CameraButton: NativeCameraButton } = require('./CameraButton.native') as {
    CameraButton: CameraButtonComponent;
  };
  ComponentImpl = NativeCameraButton;
}

export const CameraButton = memo((props: CameraButtonProps) => ComponentImpl(props));
