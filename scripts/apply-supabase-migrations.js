...
async function main() {
    ...
    if (tablesExist) {
        ...
        log('   If you want to re-apply migrations, drop tables first or use Supabase Dashboard.\n', 'yellow');
    } else {
    ...
    log('   1. Go to: https://supabase.com/dashboard/project/gujyzwqcwecbeznlablx', 'cyan');
    ...
    log('⚠️  Automated SQL execution via JS client is not supported by Supabase', 'yellow');
    log('   The Supabase JS client is designed for data operations, not schema changes.', 'yellow');
