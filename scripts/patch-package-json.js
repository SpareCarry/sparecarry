...
const pins = {
  ...
  "@supabase/ssr": "0.1.0",
  "@stripe/react-stripe-js": (p.dependencies && p.dependencies["@stripe/react-stripe-js"]) ? "2.9.0" : undefined,
  "@stripe/stripe-js": (p.dependencies && p.dependencies["@stripe/stripe-js"]) ? "2.4.0" : undefined,
  "typescript": (p.devDependencies && p.devDependencies["typescript"]) ? "5.9.3" : undefined
};
