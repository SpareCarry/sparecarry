      ...
      try {
        ...
        for (let attempt = 0; attempt < 5; attempt++) {
          try {
            ...
            if (attempt === 4) {
              console.warn(
                `Warning: Could not remove ${sourcePath} after 5 attempts: ${err.message}`
              );
              console.warn(
                `The copy was successful - you may need to manually remove ${sourcePath}`
              );
            }
          }
        }
      ...
      try {
        ...
        for (let attempt = 0; attempt < 5; attempt++) {
          try {
            ...
            if (attempt === 4) {
              console.warn(
                `Warning: Could not remove ${sourcePath}: ${err.message}`
              );
            }
          }
        }
