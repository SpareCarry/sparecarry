...
const expoPushServicePath = path.join(__dirname, '..', 'lib', 'notifications', 'expo-push-service.ts');
...
console.log('');
console.log('🎉 All checks passed! Your notification system is configured correctly.');
console.log('');
console.log('💡 Next steps:');
console.log('   1. Start your Next.js dev server: pnpm dev');
console.log('   2. Test with a real user: node scripts/test-notifications.js --type=both --recipientId=user-id');
