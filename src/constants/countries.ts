 ...
 * - Can add flags
 * - Can be replaced with DB-backed list if needed (see docs/COUNTRIES.md)
 */
 ...
 * Sorted alphabetically by name for easy reading
 */
 ...
 * @param code - Two-letter ISO country code (e.g., "US", "GB")
 ...
 * @param code - Three-letter ISO country code (e.g., "USA", "GBR")
 * @returns Country object or undefined if not found
 */
