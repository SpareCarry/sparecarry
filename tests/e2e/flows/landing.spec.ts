...
test.describe("Landing Page", () => {
  ...
  test("should navigate to login when clicking plane button", async ({
    page,
  }) => {
    await page.goto(baseUrl, { waitUntil: "domcontentloaded" });
    await waitForPageReady(page);
  ...
  test("should navigate to login when clicking boat button", async ({
    page,
  }) => {
    await page.goto(baseUrl, { waitUntil: "domcontentloaded" });
    await waitForPageReady(page);
  ...
  test("should show waitlist form when opened", async ({ page }) => {
    ...
    const waitlistButton = page
      .locator('button:has-text("Join Waitlist"), button:has-text("Waitlist")')
      .first();
