...
test.describe("Sidebar Navigation", () => {
  ...
  test("should navigate from shipping estimator via sidebar", async ({
    page,
  }) => {
    await enableTestMode(page, USER_A);
  ...
  test("should highlight current page in sidebar", async ({ page }) => {
    ...
    const estimatorLink = page.getByRole("link", {
      name: /Shipping Estimator/i,
    });
