...
test.describe('Item Safety Score', () => {
  ...
  test('should compute safety score for listing with batteries and high value', async ({ page }) => {
    ...
    const valueInput = page.locator('input[name="value_usd"], input[placeholder*="value" i]').first();
