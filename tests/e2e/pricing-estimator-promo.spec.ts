...
test.describe("Pricing Estimator with Promo", () => {
  ...
  test("should show Early Supporter Reward message during promo", async ({
    page,
  }) => {
  ...
  test("should not show promo on shipping calculator if suppressed", async ({
    page,
  }) => {
