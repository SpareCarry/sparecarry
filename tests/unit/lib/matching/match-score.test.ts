...
describe('calculateMatchScore', () => {
  ...
  it('should reward verified and high-rated travelers', () => {
    ...
    expect(highTrustResult.trustScore).toBeGreaterThan(lowTrustResult.trustScore);
    expect(highTrustResult.totalScore).toBeGreaterThan(lowTrustResult.totalScore);
  });
});
