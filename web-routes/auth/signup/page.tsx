    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-sky-200 via-teal-300 to-slate-900 px-4 py-12">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1 text-center">
          <CardTitle className="text-3xl font-bold text-slate-900">Join CarrySpace</CardTitle>
            ...
            <form onSubmit={handleMagicLink} className="space-y-4">
              ...
              <div className="rounded-md bg-blue-50 p-3 text-sm text-blue-800">
                ...
                <p className="mt-1 text-blue-700">
                  You&apos;ll receive a magic link via email. For future logins, you can use magic link or Google OAuth. 
                  To use password login, choose &quot;Password&quot; signup instead.
                </p>
              </div>
