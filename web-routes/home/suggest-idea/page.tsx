        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-green-900">Idea Submitted!</h2>
                <p className="text-green-700 mt-2">
                  Thank you for your idea. We&apos;ll review it and get back to you if it&apos;s chosen.
                </p>
              </div>
              <Button
    ...
    <div className="max-w-2xl mx-auto px-4 py-6 pb-24 lg:pb-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Share your ideas to improve SpareCarry. If your idea is chosen, you&apos;ll receive a lifetime Pro subscription!
          </CardDescription>
        </CardHeader>
        <CardContent>
